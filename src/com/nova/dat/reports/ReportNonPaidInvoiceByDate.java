 ...
 * sin cancelar por fecha utilizando JasperReports
 * @author Camilo Nova
 * @version 1.0
 */
public class ReportNonPaidInvoiceByDate {

	private String reportPath = "/reports/facturasNoCanceladasxFechas.jasper";
	 ...
	 * @since 1.0
	 */
	public ReportNonPaidInvoiceByDate(Calendar beginDate, Calendar endDate, String owner) {
		try {
